        ...
        childrens: [
            {
                ...
                icon: <BanknoteIcon className="stroke-current" />
            },
            {
                name: "paymentType",
                path: "/paymentSettings/paymentType",
                icon: <HandCoins className="stroke-current" />
            },
            {
                name: "financialInstitution",
                path: "/paymentSettings/financialInstitution",
                icon: <Landmark className="stroke-current" />
            },
            {
            ...
            },
            {
                ...
                icon: <TerminalIntegrationsIcon className="" />
            }
        ]
    };
