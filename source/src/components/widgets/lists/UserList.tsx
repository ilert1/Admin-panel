    ...
    return (
        <div className="flex flex-col gap-4 mb-6">
            <div className="flex justify-between items-end">
                ...
                <Dialog>
                    <DialogTrigger>
                        <div className="text-white dark:text-neutral-100 whitespace-nowrap rounded-4 text-sm ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 duration-200 h-9 px-4 py-2 bg-green-50 hover:bg-green-40 active:bg-green-20 disabled:bg-neutral-20 disabled:text-neutral-80 flex items-center justify-center gap-1 font-normal">
