        ...
        return (
            <div className="relative flex items-center w-full">
                <input
                    ...
                    disabled={disabled}
                    className={cn(
                        "flex h-9 w-full rounded-4 text-neutral-80 border border-neutral-40 dark:border-neutral-60 hover:border-green-50 active:border-green-50 focus:border-green-50 bg-neutral-0 px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-neutral-60 focus:outline-none disabled:text-neutral-70 transition duration-200 !text-neutral-80 dark:!text-white ",
                        `flex h-9 w-full rounded-4 text-neutral-80 border border-neutral-40 dark:border-neutral-60 hover:border-green-50 active:border-green-50 focus:border-green-50 bg-neutral-0 px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-neutral-50 focus:outline-none disabled:border-neutral-40 disabled:dark:bg-neutral-10 disabled:bg-neutral-10 transition duration-200 !text-neutral-80 dark:!text-white ${
