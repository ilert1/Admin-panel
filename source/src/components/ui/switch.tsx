...
>(({ className, ...props }, ref) => (
    <SwitchPrimitives.Root
        ...
        <SwitchPrimitives.Thumb
            className={cn(
                "ml-[1px] pointer-events-none block h-5 w-5 rounded-full bg-green-50 shadow-lg ring-0 transition-transform data-[state=checked]:translate-x-5 data-[state=unchecked]:translate-x-0 border-[1px] border-green-40"
            )}
        />
    </SwitchPrimitives.Root>
));
