    ...
    return (
        <>
            <div className="flex flex-shrink-0 justify-end h-[84px] items-center gap-8 bg-header px-4 relative z-100 pointer-events-auto z">
                        ...
                        <div className="flex items-center">
                            <div
                                className={cn(
                                    ...
                                    theme === "dark"
                                        ? "translate-x-0 ml-[7px] opacity-100"
                ...
                {/* <div
                    className="flex relative w-32 h-14 rounded-full bg-white dark:bg-black border border-neutral-200 cursor-pointer overflow-hidden"
                    onClick={toggleTheme}>
                    <div className="absolute inset-0 flex items-center">
                        <div
                            className={`
          absolute p-2 rounded-full bg-neutral-100
          transition-all duration-500 ease-in-out
          ${theme === "dark" ? "translate-x-2 opacity-100" : "translate-x-full opacity-0"}
        `}>
                            <MoonIcon className="w-6 h-6 text-neutral-800" />
                        </div>
          ...
          transition-all duration-500 ease-in-out
          ${theme === "dark" ? "-translate-x-full opacity-0" : "translate-x-2 opacity-100"}
        `}>
