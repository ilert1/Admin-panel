...
export const getProviderEndpointsListProvidersEnigmaV1ProviderGetUrl = (
    ...
    return stringifiedParams.length > 0
        ? `https://example.com/enigma/v1/provider?${stringifiedParams}`
        : `https://example.com/enigma/v1/provider`;
};
...
export const getProviderEndpointsCreateProviderEnigmaV1ProviderPostUrl = () => {
    return `https://example.com/enigma/v1/provider`;
};
...
export const getProviderEndpointsGetProviderByIdEnigmaV1ProviderProviderIdGetUrl = (providerId: string) => {
    return `https://example.com/enigma/v1/provider/${providerId}`;
};
...
export const getProviderEndpointsAddKeypairByIdEnigmaV1ProviderProviderIdAddKeypairPatchUrl = (
    ...
    return stringifiedParams.length > 0
        ? `https://example.com/enigma/v1/provider/${providerId}/add_keypair?${stringifiedParams}`
        : `https://example.com/enigma/v1/provider/${providerId}/add_keypair`;
};
...
export const getProviderEndpointsAddPaymentTypesToProviderByIdEnigmaV1ProviderProviderIdAddPaymentTypesPatchUrl = (
    ...
    return `https://example.com/enigma/v1/provider/${providerId}/add_payment_types`;
};
...
export const getProviderEndpointsRemovePaymentTypeFromProviderByIdEnigmaV1ProviderProviderIdRemovePaymentTypePaymentTypeCodeDeleteUrl =
    (providerId: string, paymentTypeCode: string) => {
        return `https://example.com/enigma/v1/provider/${providerId}/remove_payment_type/${paymentTypeCode}`;
    };
