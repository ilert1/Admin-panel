...
export const getCurrencyEndpointsListCurrenciesEnigmaV1CurrencyGetUrl = (
    ...
    return stringifiedParams.length > 0
        ? `https://api.develop.blowfish.api4ftx.cloud/enigma/v1/currency?${stringifiedParams}`
        : `https://api.develop.blowfish.api4ftx.cloud/enigma/v1/currency`;
};
...
export const getCurrencyEndpointsCreateCurrencyEnigmaV1CurrencyPostUrl = () => {
    return `https://api.develop.blowfish.api4ftx.cloud/enigma/v1/currency`;
};
...
export const getCurrencyEndpointsGetCurrencyEnigmaV1CurrencyCurrencyCodeGetUrl = (currencyCode: string) => {
    return `https://api.develop.blowfish.api4ftx.cloud/enigma/v1/currency/${currencyCode}`;
};
