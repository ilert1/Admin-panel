 ...
 * HTTP method
 */
export type CallbackHistoryReadRequestMethod = string | null;
...
export type CallbackHistoryReadRequestHeadersAnyOf = { [key: string]: unknown };

/**
 * Incoming headers
 */
export type CallbackHistoryReadRequestHeaders = CallbackHistoryReadRequestHeadersAnyOf | null;

export type CallbackHistoryReadRequestParamsAnyOf = { [key: string]: unknown };

/**
 * Incoming query params
 */
export type CallbackHistoryReadRequestParams = CallbackHistoryReadRequestParamsAnyOf | null;
 ...
 * Processing status
 */
export type CallbackHistoryReadStatus = CallbackStatusEnum | null;

/**
 * What triggered this delivery
 */
export type CallbackHistoryReadTriggerType = CallbackTriggerType | null;
...
export interface CallbackHistoryRead {
    ...
    original_url: string;
    /** HTTP method */
    request_method?: CallbackHistoryReadRequestMethod;
    /** Full callback URL */
    ...
    /** Processing status */
    status?: CallbackHistoryReadStatus;
    /** What triggered this delivery */
    trigger_type?: CallbackHistoryReadTriggerType;
