 ...
 */
export type callbackMappingEndpointsBulkCreateOrUpdateMappingViaInternalPathCallbridgeV1MappingBulkCreatePostResponse200 =
    {
        data: ApiResponseCallbackMappingBulkResponse;
        status: 200;
    };

export type callbackMappingEndpointsBulkCreateOrUpdateMappingViaInternalPathCallbridgeV1MappingBulkCreatePostResponse422 =
    {
        data: HTTPValidationError;
        status: 422;
    };

export type callbackMappingEndpointsBulkCreateOrUpdateMappingViaInternalPathCallbridgeV1MappingBulkCreatePostResponseComposite =

        | callbackMappingEndpointsBulkCreateOrUpdateMappingViaInternalPathCallbridgeV1MappingBulkCreatePostResponse200
        | callbackMappingEndpointsBulkCreateOrUpdateMappingViaInternalPathCallbridgeV1MappingBulkCreatePostResponse422;

export type callbackMappingEndpointsBulkCreateOrUpdateMappingViaInternalPathCallbridgeV1MappingBulkCreatePostResponse =
    callbackMappingEndpointsBulkCreateOrUpdateMappingViaInternalPathCallbridgeV1MappingBulkCreatePostResponseComposite & {
        headers: Headers;
    };

export const getCallbackMappingEndpointsBulkCreateOrUpdateMappingViaInternalPathCallbridgeV1MappingBulkCreatePostUrl =
    () => {
        return `https://apigate.develop.blowfish.api4ftx.cloud/callbridge/v1/mapping/bulk/create`;
    };

export const callbackMappingEndpointsBulkCreateOrUpdateMappingViaInternalPathCallbridgeV1MappingBulkCreatePost = async (
    callbackMappingBulkCreate: CallbackMappingBulkCreate,
    options?: RequestInit
): Promise<callbackMappingEndpointsBulkCreateOrUpdateMappingViaInternalPathCallbridgeV1MappingBulkCreatePostResponse> => {
    return authFetch<callbackMappingEndpointsBulkCreateOrUpdateMappingViaInternalPathCallbridgeV1MappingBulkCreatePostResponse>(
        getCallbackMappingEndpointsBulkCreateOrUpdateMappingViaInternalPathCallbridgeV1MappingBulkCreatePostUrl(),
        {
            ...options,
            method: "POST",
            headers: { "Content-Type": "application/json", ...options?.headers },
